...
exports.SupportsWebcam = undefined;
...
var getUserMedia = navigator.mediaDevices && navigator.mediaDevices.getUserMedia && navigator.mediaDevices.getUserMedia.bind(navigator.mediaDevices);

var SupportsWebcam = exports.SupportsWebcam = !!getUserMedia;
    ...
    value: function requestUserMedia() {
      ...
      var sourceSelected = function sourceSelected(audioSource, videoSource) {
        ...
        var logError = function logError(e) {
          return console.log("error", e, typeof e === "undefined" ? "undefined" : _typeof(e));
...
Webcam.propTypes = {
  ...
  facingMode: _propTypes2.default.oneOf(["user", "environment", "left", "right"]),
